<!-- TOC START -->
- [Source node vs Sink node](#source-node-vs-sink-node)
- [Compiler](#compiler)
- [GDB](#gdb)
  - [Print real type of an object](#print-real-type-of-an-object)
  - [Print vtable of an object](#print-vtable-of-an-object)
  - [Generate core file](#generate-core-file)
- [std::map](#stdmap)
- [How can an user-space application call a device driver function?](#how-can-an-user-space-application-call-a-device-driver-function)
- [Comma Operator](#comma-operator)
- [Squiggles](#squiggles)
- [_GLIBCXX_USE_CXX11_ABI](#_glibcxx_use_cxx11_abi)
- [Extract Static Library](#extract-static-library)
- [Feature Column](#feature-column)
    - [Example in TensorFlow](#example-in-tensorflow)
- [Multiple glibc on a Single Linux](#multiple-glibc-on-a-single-linux)
- [First, we’ll add an rpath to our binary executable for our preferred glibc:](#first-well-add-an-rpath-to-our-binary-executable-for-our-preferred-glibc)
- [Similarly, we can update the rpath with the –set-rpath option. This might break the program, so use it with caution:](#similarly-we-can-update-the-rpath-with-the-set-rpath-option-this-might-break-the-program-so-use-it-with-caution)
- [To remove an existing rpath:](#to-remove-an-existing-rpath)
- [We can also update the dynamic linker with —set-interpreter:](#we-can-also-update-the-dynamic-linker-with-set-interpreter)
- [Get rpath and set rpath](#get-rpath-and-set-rpath)
- [Fix rpath for python](#fix-rpath-for-python)
- [iTerm2](#iterm2)
- [Blade](#blade)
- [vtable for __cxxabiv1::__class_type_info](#vtable-for-__cxxabiv1__class_type_info)
- [Template Non-Deduced Context](#template-non-deduced-context)
- [Template Default Arguments](#template-default-arguments)
- [GLIBC_PRIVATE](#glibc_private)
- [gdb displays next instruction](#gdb-displays-next-instruction)
- [symbol lookup error](#symbol-lookup-error)
- [Check GPU Memory Usage](#check-gpu-memory-usage)
- [TensorFlow logging](#tensorflow-logging)
- [TensorFlow Session Run Call Stack:](#tensorflow-session-run-call-stack)
- [TensorFlow GraphDef Manipulation](#tensorflow-graphdef-manipulation)
  - [Add a new node to Graph](#add-a-new-node-to-graph)
  - [Modify an existing node](#modify-an-existing-node)
- [clang format](#clang-format)
- [union](#union)
- [binary/bit format](#binarybit-format)
- [OpenSSL](#openssl)
- [DWARF debug info](#dwarf-debug-info)
- [Jupyter Notebook](#jupyter-notebook)
- [Macro](#macro)
- [enum](#enum)
    - [1. **Unscoped Enum** (C++98 style)](#1-unscoped-enum-c98-style)
      - [Example:](#example)
    - [2. **Scoped Enum** (C++11 and newer)](#2-scoped-enum-c11-and-newer)
      - [Example:](#example)
    - [Summary](#summary)
- [CV-qualifiers](#cv-qualifiers)
    - [Types of CV-Qualifiers](#types-of-cv-qualifiers)
    - [Application of CV-Qualifiers](#application-of-cv-qualifiers)
    - [CV-Qualifier Rules](#cv-qualifier-rules)
    - [Summary](#summary)
- [GCC](#gcc)
- [Make a constexpr function run at runtime](#make-a-constexpr-function-run-at-runtime)
- [ADL - Argument-Dependent Lookup](#adl-argument-dependent-lookup)
- [Type of an object](#type-of-an-object)
    - [1. **Compile-time Storage (Symbol Table)**:](#1-compile-time-storage-symbol-table)
    - [2. **Runtime Type Information (RTTI)**:](#2-runtime-type-information-rtti)
    - [3. **Non-polymorphic Types**:](#3-non-polymorphic-types)
    - [Summary:](#summary)
- [static_cast](#static_cast)
    - [Overview of `static_cast` in C++](#overview-of-static_cast-in-c)
    - [Key Characteristics of `static_cast`](#key-characteristics-of-static_cast)
    - [Syntax](#syntax)
    - [How It Works Step by Step](#how-it-works-step-by-step)
    - [Concrete Examples](#concrete-examples)
      - [Example 1: Numeric Conversions](#example-1-numeric-conversions)
      - [Example 2: Upcasting in an Inheritance Hierarchy](#example-2-upcasting-in-an-inheritance-hierarchy)
      - [Example 3: Downcasting in an Inheritance Hierarchy](#example-3-downcasting-in-an-inheritance-hierarchy)
      - [Example 4: Casting `void*` to a Specific Type](#example-4-casting-void-to-a-specific-type)
      - [Example 5: Prohibited Casts](#example-5-prohibited-casts)
    - [Behind the Scenes](#behind-the-scenes)
    - [Use Cases of `static_cast`](#use-cases-of-static_cast)
    - [Summary](#summary)
- [The ->* operator](#the-operator)
  - [Why `->*` Is Needed](#why-is-needed)
- [rvalue reference](#rvalue-reference)
- [Octal escape sequences](#octal-escape-sequences)
- [std::enable_if_t](#stdenable_if_t)
- [Pack expansion](#pack-expansion)
- [String concatenation](#string-concatenation)
- [Stack unwinding during exception handling in C++](#stack-unwinding-during-exception-handling-in-c)
  - [Stack and stack frame:](#stack-and-stack-frame)
