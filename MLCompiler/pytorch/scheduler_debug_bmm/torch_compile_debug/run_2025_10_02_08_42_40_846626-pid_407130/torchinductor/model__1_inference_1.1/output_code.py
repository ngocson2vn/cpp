...
# kernel path: /data00/home/son.nguyen/workspace/cpp/MLCompiler/pytorch/scheduler_debug_bmm/aot/inductor/v7/cv7u3hlces3qnsn4dvopcxly6zzap6zvpcjyykfzgot6jeugziu4.py
...
def call(args):
    ...
    args.clear()
    s0 = arg0_1
    assert_size_stride(arg1_1, (s0, 64, 64), (4096, 64, 1))
    assert_size_stride(arg2_1, (s0, 31, 64), (1984, 64, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf0 = empty_strided_cuda((s0, 31, 64), (1984, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [tmp1], Original ATen: [aten.bmm]
        extern_kernels.bmm(arg2_1, arg1_1, out=buf0)
        del arg1_1
        del arg2_1
        buf1 = buf0; del buf0  # reuse
        # Topologically Sorted Source Nodes: [res], Original ATen: [aten.sigmoid]
        # Fused node name list: op1
        triton_poi_fused_sigmoid_0_xnumel = 1984*s0
        stream0 = get_raw_stream(0)
        triton_poi_fused_sigmoid_0.run(buf1, triton_poi_fused_sigmoid_0_xnumel, stream=stream0)
    return (buf1, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 32
    arg1_1 = rand_strided((32, 64, 64), (4096, 64, 1), device='cuda:0', dtype=torch.float32)
    arg2_1 = rand_strided((32, 31, 64), (1984, 64, 1), device='cuda:0', dtype=torch.float32)
