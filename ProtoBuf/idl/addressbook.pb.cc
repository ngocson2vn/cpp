...
// source: idl/addressbook.proto

#include "idl/addressbook.pb.h"
...
static ::_pb::Metadata file_level_metadata_idl_2faddressbook_2eproto[3];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_idl_2faddressbook_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_idl_2faddressbook_2eproto = nullptr;

const uint32_t TableStruct_idl_2faddressbook_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_idl_2faddressbook_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\025idl/addressbook.proto\022\010tutorial\"\333\001\n\006Pe"
  ...
  ;
static ::_pbi::once_flag descriptor_table_idl_2faddressbook_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_idl_2faddressbook_2eproto = {
    false, false, 304, descriptor_table_protodef_idl_2faddressbook_2eproto,
    "idl/addressbook.proto",
    &descriptor_table_idl_2faddressbook_2eproto_once, nullptr, 0, 3,
    schemas, file_default_instances, TableStruct_idl_2faddressbook_2eproto::offsets,
    file_level_metadata_idl_2faddressbook_2eproto, file_level_enum_descriptors_idl_2faddressbook_2eproto,
    file_level_service_descriptors_idl_2faddressbook_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_idl_2faddressbook_2eproto_getter() {
  return &descriptor_table_idl_2faddressbook_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_idl_2faddressbook_2eproto(&descriptor_table_idl_2faddressbook_2eproto);
namespace tutorial {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Person_PhoneType_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_idl_2faddressbook_2eproto);
  return file_level_enum_descriptors_idl_2faddressbook_2eproto[0];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Person_PhoneNumber::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_idl_2faddressbook_2eproto_getter, &descriptor_table_idl_2faddressbook_2eproto_once,
      file_level_metadata_idl_2faddressbook_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Person::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_idl_2faddressbook_2eproto_getter, &descriptor_table_idl_2faddressbook_2eproto_once,
      file_level_metadata_idl_2faddressbook_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata AddressBook::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_idl_2faddressbook_2eproto_getter, &descriptor_table_idl_2faddressbook_2eproto_once,
      file_level_metadata_idl_2faddressbook_2eproto[2]);
}
